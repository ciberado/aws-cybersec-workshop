...
export async function validateSecurityGroups(credentials) {
...
function validateAlbsg(securityGroups) {
    ...
    if (!hasHttp80)
        actualRules.push('❌ Missing: HTTP (TCP:80) from 0.0.0.0/0');
    if (!hasHttps443)
        actualRules.push('❌ Missing: HTTPS (TCP:443) from 0.0.0.0/0');
...
function validateAppsg(securityGroups, albsgId) {
...
function validateBdsg(securityGroups, appsgId) {
